...
All API requests require an API key for authentication. You can create and manage API keys in your [Dashboard](https://gistmag.com/dashboard/api-key).
...
```bash
curl "https://api.gistmag.com/usage?api_key=your_api_key_here"
```
