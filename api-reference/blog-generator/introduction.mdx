---
title: "Blog Generator Introduction"
description: "Generate images, excerpt, category, and tags for blog posts"
---

## Overview

The GistMag Blog Generator API helps you create complete blog post assets using AI. With a single API call, you can generate:
...
The Blog Generator costs **3 credits per generation**, which includes:
