...
- **Recommended**: For text longer than 20,000 characters, split it into multiple batch requests or use the [streaming endpoint](/api-reference/tts/stream)
...
1. **For very long content** (> 20,000 characters): Split into multiple batch requests or use streaming
