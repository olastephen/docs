...
description: "List available Text-to-Speech voices across both engines"
api: "GET /tts/voices"
---

## Overview

Retrieve the list of available Text-to-Speech voices across both engines, so you can pick a specific `voice_name` when calling the [`/tts`](/api-reference/tts/basic) endpoint.
