...
description: "Complete API documentation for GistMag – AI-powered alt text, speech, blog metadata and site audits."
---
...
<Columns cols={2}>
  ...
  <Card
    title="Blog Metadata"
    icon="pen"
    href="/api-reference/blog-generator/introduction"
  >
