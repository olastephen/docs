...
2. The plugin will download the image from Supabase Storage and set it as your post's featured image
3. Images are automatically uploaded to Supabase Storage and returned as public URLs for easy use
4. The page will refresh to show the new featured image
...
- Images are downloaded from Supabase Storage URLs, so ensure your server can access external URLs
